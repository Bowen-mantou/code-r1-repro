...
| 实验 | 配方（修正后真相）| HumanEval | HumanEval+ | MBPP | MBPP+ | LCB | CodeContests |
|------|------|-----------|-----------|------|-------|-----|--------------|
| E1 | GRPO 二进制，4ep 过训 | 86.6 | 80.5 | 77.5 | 64.3 | 19.8 | — |
| E2 | GRPO+手写PRM | 82.3 | 74.4 | 76.5 | **64.6** | 21.0 | 3.03 |
| E5 | 纯 OPD 蒸馏 | 85.4 | 81.1 | 75.1 | 62.7 | 24.7 | — |
| E7 | 纯 GRPO 2ep（verifier 信号**未生效**——链路 bug）| **86.6** | **82.3** | 77.0 | 63.2 | **25.2** | 3.6 |
| E9p2 | E5 起点 + 纯 GRPO 2ep（同上 bug）| 86.0 | 80.5 | **78.6** | 64.3 | **25.2** | — |
| E9p3 | E9p2 + verifier 门控蒸馏（gate 真生效，通过率 0.18）| 86.0 | 80.5 | 78.8 | 64.3 | 24.8 | — |
