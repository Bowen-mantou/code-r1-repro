"""E9 阶段 2：veRL FSDP checkpoint (global_step_472) → HF 格式（bf16），评估用"""
import os
import shutil
...
CKPT = ("/root/autodl-tmp/checkpoints/code-r1/e9-phase2-grpo-verifier-3b/"
        "global_step_472/actor/model_world_size_1_rank_0.pt")
CFG_DIR = ("/root/autodl-tmp/checkpoints/code-r1/e9-phase2-grpo-verifier-3b/"
           "global_step_472/actor/huggingface")
DST = "/root/autodl-tmp/models/e9-phase2-final"
