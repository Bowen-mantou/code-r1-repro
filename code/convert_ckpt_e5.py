"""E5：veRL FSDP checkpoint (global_step_448) → HF 格式（bf16），评估用"""
import os
import shutil
...
CKPT = ("/root/autodl-tmp/checkpoints/code-r1/e5-opd-gkd-3b/"
        "global_step_448/actor/model_world_size_1_rank_0.pt")
CFG_DIR = ("/root/autodl-tmp/checkpoints/code-r1/e5-opd-gkd-3b/"
           "global_step_448/actor/huggingface")
DST = "/root/autodl-tmp/models/e5-final-3b"
